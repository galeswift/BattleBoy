...
typedef void    (CALLBACK *LPDXUTCALLBACKCHAR)( wchar_t nChar, void* pUserContext );
...
typedef void	(CALLBACK *LPDXUTCALLBACKASKSCREENSIZE)( int* pWidth, int* pHeight, void* pUserContext );
...
void WINAPI DXUTSetCallbackChar( LPDXUTCALLBACKCHAR pCallback, void* pUserContext = NULL );
...
void WINAPI DXUTSetCallbackAskScreenSize( LPDXUTCALLBACKASKSCREENSIZE pCallback, void* pUserContext = NULL );
...
HRESULT WINAPI DXUTCreateWindow( const WCHAR* strWindowTitle = L"World of Goo", 
